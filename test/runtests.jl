...
# !!! Main.UserApp is configured as an alias for Main.Science and you might encounter it in some tests
using Main.Science, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Science tests" begin
  @includetests ARGS
end
